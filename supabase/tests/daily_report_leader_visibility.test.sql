...
insert into public.daily_okr_blocks (
  ...
  linked_key_result_id, project_id, work_description, hours, result, key_results, evidence_links
) values
  ('98000000-0000-0000-0000-000000000001', '92000000-0000-0000-0000-000000000001', '96000000-0000-0000-0000-000000000001', '97000000-0000-0000-0000-000000000001', 1, 'Bob today O', '95000000-0000-0000-0000-000000000001', '93000000-0000-0000-0000-000000000001', '完成接口联调', 8, '接口通过', '[{"title":"完成接口联调"}]'::jsonb, '[]'::jsonb),
  ('98000000-0000-0000-0000-000000000002', '92000000-0000-0000-0000-000000000001', '96000000-0000-0000-0000-000000000002', '97000000-0000-0000-0000-000000000002', 1, 'Bob draft O', '95000000-0000-0000-0000-000000000001', '93000000-0000-0000-0000-000000000001', '整理草稿', 4, '草稿完成', '[{"title":"整理草稿"}]'::jsonb, '[]'::jsonb),
  ('98000000-0000-0000-0000-000000000003', '92000000-0000-0000-0000-000000000001', '96000000-0000-0000-0000-000000000003', '97000000-0000-0000-0000-000000000003', 1, 'Dana today O', '95000000-0000-0000-0000-000000000002', '93000000-0000-0000-0000-000000000002', 'Project B work', 8, 'Done', '[{"title":"Project B work"}]'::jsonb, '[]'::jsonb),
  ('98000000-0000-0000-0000-000000000004', '92000000-0000-0000-0000-000000000001', '96000000-0000-0000-0000-000000000004', '97000000-0000-0000-0000-000000000004', 1, 'Bob confirmed O', '95000000-0000-0000-0000-000000000001', '93000000-0000-0000-0000-000000000001', '确认完成', 4, '已确认', '[{"title":"确认完成"}]'::jsonb, '[]'::jsonb),
  ('98000000-0000-0000-0000-000000000005', '92000000-0000-0000-0000-000000000001', '96000000-0000-0000-0000-000000000005', '97000000-0000-0000-0000-000000000005', 1, 'Bob returned O', '95000000-0000-0000-0000-000000000001', '93000000-0000-0000-0000-000000000001', '退回重做', 4, '已退回', '[{"title":"退回重做"}]'::jsonb, '[]'::jsonb);
