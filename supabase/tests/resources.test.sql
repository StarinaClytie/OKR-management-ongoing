...
insert into public.resource_attachments (id, organization_id, resource_id, uploader_id, file_name, storage_path, mime_type, size_bytes, state, object_verified_at) values
  ('24000000-0000-0000-0000-000000000002', '23000000-0000-0000-0000-000000000001', '24000000-0000-0000-0000-000000000001', '15000000-0000-0000-0000-000000000004', 'lens-manual.pdf', 'organization/23000000-0000-0000-0000-000000000001/resources/24000000-0000-0000-0000-000000000001/manual.pdf', 'application/pdf', 1024, 'uploaded', timezone('utc', now()));
